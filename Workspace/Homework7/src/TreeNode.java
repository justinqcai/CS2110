...
public class TreeNode<T extends Comparable<T>> {
     ...
     * toString method
     * 
     * @return String representation of the TreeNode structure
     */
    @Override
	...
	/**
	 * 
	 * @return a String containing the inOrder traversal of the TreeNode structure
	 */
     ...
     * 
     * 
     * @return a String containing the postOrder traversal of the TreeNode structure
     */
